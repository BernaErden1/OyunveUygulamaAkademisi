class TurkceItemler {
  ...
  final profilim = "Profilim";
  final ayarlar = "Ayarlar";
  final tarifDefterim = "Tariflerim";
  final girisYap = "Giriş Yap";
  final kayitOl = "Kayıt Ol";
  ...
  final onboard2subtext =
      "Yapmak istediğiniz yemek tariflerini kaydedin.";
  final onboard2Headtext = "Tarif defterine ekle!";
  final onboard3subtext =
      "Beğendiğiniz tarifleri dostlarınızla paylaşın.";
